    ...
    <div class="footer-columns">
        <div class="container">
            ...
            <div class="footer-ad-banner">
                <a href="#"><img src="{{ asset('/frontend/images/footer-ad-banner.jpg') }}" alt=""></a>
            </div>
            <!-- Add banner -->
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="footer-column logo-column">
                        <a href="index-1.html"><img src="{{ asset('/frontend/images/logo-2.png') }}" alt=""></a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <ul class="cards-list">
                        <li><img src="{{ asset('/frontend/images/cards/img-01.jpg') }}" alt=""></li>
                        <li><img src="{{ asset('/frontend/images/cards/img-02.jpg') }}" alt=""></li>
                        <li><img src="{{ asset('/frontend/images/cards/img-03.jpg') }}" alt=""></li>
                        <li><img src="{{ asset('/frontend/images/cards/img-04.jpg') }}" alt=""></li>
                    </ul>
                </div>
            </div>
        </div>
