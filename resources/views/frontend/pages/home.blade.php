                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xs-12">
                        <div class="services-text"> 
                            ...
                            <p>The Books stock is India’s best book Marketplace where you can get all kinds of books , Books stock offers millions of new and used items from a network of trusted Sellers,  often at discounted prices -- all with the security and guarantee of Books Stock.</br> 

                            Our special collection of Rare &amp; Collectible Books features include all types of books whether new or used . With so many genres, it is important to give customers an easy way to find precisely the books they are looking for.
                             </p>
                            <a href="{{  url('/about-us') }}" class="btn-1 sm shadow-0">Read more<i aria-hidden="true" class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- Services Text -->
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="service-column">
                                        ...
                                        <p>Books Stock advance search has made it easier for you to get a book you are looking for. We have always focused on making the Customer satisfaction hence we have made sure that even a kid can search for the book he is looking for.
</p>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="service-column m-0">
                                        ...
                                        <p>Books Stock has provided and exaggerated market for books and also a platform where you can establish yourself as a professional book seller now you can manage all your accounts on books stock with easy to use  interface we have made sure you get every possible benefit of being a part of Books stock.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
