<aside class="main-sidebar hidden-print">
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview"><a href="#"><i class="fa fa-th-large"></i><span>Categories</span><i class="fa fa-angle-right"></i></a>
                <ul class="treeview-menu">
                    <li>
                        <a href="{{ url('/admin/categories') }}">
                            <i class="fa fa-circle-o"></i> View All
            ...
            <li class="treeview"><a href="#"><i class="fa fa-user"></i><span>Users</span><i class="fa fa-angle-right"></i></a>
                <ul class="treeview-menu">
                    <li>
                        <a href="{{ url('/admin/users') }}">
                            <i class="fa fa-circle-o"></i> View All
...
<<<<<<< HEAD
            <li class="treeview"><a href="{{ url('/admin/sliders') }}"><i class="fa fa-file-image-o"></i><span>Sliders</span><i class="fa fa-angle-right"></i></a>
                <ul class="treeview-menu">
                    <li>
