	    		...
	    		<div class="row">
		    		...
		    		<div class="col-lg-4 col-sm-6">
		    			<div class="footer-column logo-column">
		    				...
		    				<p>Find out books of colleges, schools, individuals. You can also upload your own book. Uploading your own book will be a wonderful opportunity for writers.</p>
		    				<ul class="address-list">
		    					<li><i class="fa fa-home"></i>888 South Avenue Street, Jaipur City.</li>
		    					<li><i class="fa fa-phone"></i>00+123-456-789</li>
		    					<li><i class="fa fa-envelope"></i>booksstocks@gmail.com</li>
		    				</ul>
		    			</div>
		    		</div>
		    		<!-- Footer Column -->
	    ...
	    <!-- Sub Footer -->
	   	<div class="sub-foorer">
	   		<div class="container">
	   			<div class="row">
		   			<div class="col-sm-6">
		   				<p>Copyright <i class="fa fa-copyright"></i> <span class="theme-color">BooksStocks</span> All Rights Reserved.</p>
						<a href="#"><p>Powered by <span class="theme-color"> TWS Technoloy</span></p></a>
		   			</div>
		   			<div class="col-sm-6">
