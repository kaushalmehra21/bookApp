...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="topbar" class="hidden-xs hidden-sm">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        <ul class="top-menu">
                            <li><a href="#">Phone: +91-8387919175</a></li>
                            <li><a href="#">Email: thewebservertechnology@gmail.com</a></li>
                        </ul>
                    </div>
        ...
        <div id="slider" class="inspiro-slider" data-height-xs="360">
            ...
            <div class="slide" style="background-image:url('images/slider/banner_1.jpg');">
                <div class="container">
                    <div class="slide-captions text-dark">
                        <!-- Captions -->
                        <h1 data-caption-animation="rotateInUpLeft"></h1>
                        <h3 data-caption-animation="rotateInUpLeft" data-caption-delay="300"></h3>
                        <!-- end: Captions -->
                    </div>
                </div>
            </div>
            <!-- end: Slide 1 -->
            <!-- Slide 2 -->
            <div class="slide" style="background-image:url('images/slider/banner_2.jpg');">
                <div class="container">
                    <div class="slide-captions text-right text-dark">
                        <!-- Captions -->
                        <h1 data-caption-animation="rotateInUpRight"></h1>
                        <h3 data-caption-animation="rotateInUpRight"></h3>
                        <!-- end: Captions -->
                    </div>
                </div>
            </div>
            <!-- end: Slide 2 -->
			 <!-- Slide 3 -->
			  <div class="slide" style="background-image:url('images/slider/banner_3.png');">
                <div class="container">
                    <div class="slide-captions text-right text-dark">
                        <!-- Captions -->
                        <h1 data-caption-animation="rotateInUpRight"></h1>
        ...
        <section class="background-grey text-center p-t-60  p-b-40">
            <div class="container">
                <div class="col-md-9">
                    <h3 style="font-weight: 100;">Brace yourself! More demo layouts are comming!</h3></div>
                <div class="col-md-3"><a type="button" class="btn btn-default btn-rounded">Purchase POLO</a> </div>
            </div>
        </section>
        <!-- end: Call to action -->
        ...
        <section class="p-b-20">
            <div class="container">
                <div class="row">
                    <!-- features box -->
                    <div class="col-md-4">
                        <img src="images/web_development.png" class="img-responsive m-b-20">
                        <h4>Fully Responsive</h4>
                        <p>We’re POLO, a creative agency located in the heart of New York city. Suspendisse consectetur fringilla luctus. Fusce id mi diam, non ornare orci. Pellentesque ipsum erat, facilisis ut venenatis eu.</p>
                    </div>
                    <!-- end: features box -->

                    <!-- features box -->
                    <div class="col-md-4">
                        <img src="images/digital_marketing_4.png" class="img-responsive m-b-20">
                    ...
                    <!-- features box -->
                    <div class="col-md-4">
                        <img src="images/lead.jpg" class="img-responsive m-b-20">
                        <h4>Powerful</h4>
                        <p>We’re POLO, a creative agency located in the heart of New York city. Suspendisse consectetur fringilla luctus. Fusce id mi diam, non ornare orci. Pellentesque ipsum erat, facilisis ut venenatis eu.</p>
                    </div>
                    <!-- end: features box -->
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="text-center">
                            <div class="counter text-large"> <span data-speed="3000" data-refresh-interval="50" data-to="12416" data-from="600" data-seperator="true"></span> </div>
                    ...
                    <div class="col-md-3">
                        <div class="text-center">
                            <div class="counter text-large"> <span data-speed="4500" data-refresh-interval="23" data-to="365" data-from="100" data-seperator="true"></span> </div>
                            <div class="seperator seperator-small"></div>
                            <p>CUPS OF COFFEE</p>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="text-center">
                            <div class="counter text-large"> <span data-speed="3000" data-refresh-interval="12" data-to="114" data-from="50" data-seperator="true"></span> </div>
                            <div class="seperator seperator-small"></div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="text-center">
                            <div class="counter text-large"> <span data-speed="4550" data-refresh-interval="50" data-to="14825" data-from="48" data-seperator="true"></span> </div>
                            <div class="seperator seperator-small"></div>
        ...
        <section class="p-b-40">
            <div class="container">
                <div class="row">
                    ...
                    <!-- features box -->
                    <div class="col-md-4">
                        <h4><i class="fa fa-lightbulb-o"></i> Fast as light</h4>
                        <p>We’re POLO, a creative agency located in the heart of New York city. Suspendisse consectetur fringilla luctus. Fusce id mi diam, non ornare orci. Pellentesque ipsum erat, facilisis ut venenatis eu.</p>
                    </div>
                    <!-- end: features box -->
